...
class Admin::TypusUsersControllerTest < ActionController::TestCase
  ...
  test "admin should not be able to toogle his status" do
    setup_admin
    get :toggle, params: { id: @typus_user.id, field: 'status' }
  ...
  test "admin should be able to toggle other users status" do
    ...
    get :toggle, params: { id: @typus_user_editor.id, field: 'status' }
  ...
  test "admin should not be able to destroy himself" do
    setup_admin
    delete :destroy, params: { id: @typus_user.id }
    assert_response :unprocessable_entity
  end
  ...
  test "admin should be able to destroy other users" do
    ...
    assert_difference('TypusUser.count', -1) do
      delete :destroy, params: { id: @typus_user_editor.id }
    end
  ...
  test "admin should be able to update his profile" do
    ...
    post :update, params: { id: @typus_user.id, typus_user: { first_name: "John", last_name: "Locke", role: 'admin', status: '1' }, _save: true }
  ...
  test "admin should not be able to change his role" do
    setup_admin
    post :update, params: { id: @typus_user.id, typus_user: { role: 'editor' }, _save: true }
    assert_response :unprocessable_entity
  end

  test "admin should not be able to change his status" do
    setup_admin
    post :update, params: { id: @typus_user.id, typus_user: { status: '0' }, _save: true }
    assert_response :unprocessable_entity
  end
  ...
  test "admin should be able to update other users role" do
    ...
    post :update, params: { id: @typus_user_editor.id, typus_user: { role: 'admin' }, _save: true }
  ...
  test "editor should be able to edit his profile" do
    editor_sign_in
    get :edit, params: { id: @typus_user.id }
    assert_response :success
  ...
  test "editor is redirected to his profile after update" do
    editor_sign_in
    post :update, params: { id: @typus_user.id, typus_user: { first_name: 'John' }, _save: true }
    assert_response :redirect
  ...
  test "editor should be able to update his profile" do
    editor_sign_in
    post :update, params: { id: @typus_user.id, typus_user: { role: 'editor' }, _continue: true }
    assert_response :redirect
    assert_redirected_to "/admin/typus_users/edit/#{@typus_user.id}"
    assert_equal "Typus user successfully updated.", flash[:notice]
  end
  ...
  test "editor should not be able to change his role" do
    editor_sign_in
    post :update, params: { id: @typus_user.id, typus_user: { role: 'admin' }, _continue: true }
    assert_response :redirect
    assert_redirected_to "/admin/typus_users/edit/#{@typus_user.id}"
  ...
  test 'editor should not be able to edit other profiles' do
    editor_sign_in
    get :edit, params: { id: typus_users(:admin) }
    assert_response :unprocessable_entity
  end

  test 'editor should not be able to update other profiles' do
    editor_sign_in
    post :update, params: { id: typus_users(:admin), typus_user: { role: 'admin' } }
    assert_response :unprocessable_entity
  end

  test 'editor should not be able to destroy other profiles' do
    editor_sign_in
    delete :destroy, params: { id: typus_users(:admin) }
    assert_response :unprocessable_entity
  end

  test 'editor should not be able to toggle other profiles status' do
    editor_sign_in
    get :toggle, params: { id: typus_users(:admin), field: 'status' }
    assert_response :unprocessable_entity
  end
  ...
  test "designer should be able to update his profile" do
    ...
    post :update, params: { id: @typus_user.id, typus_user: { role: 'designer', email: 'designer@withafancydomain.com' }, _save: true }
  ...
  test "password cannot be set to blank" do
    setup_admin
    post :update, params: { id: @typus_user.id, typus_user: { first_name: "John", last_name: "Locke", password: '', role: 'admin', status: '1' }, _save: true }
    assert_response :redirect
