...
class Admin::ProjectsControllerTest < ActionController::TestCase
  ...
  test 'get new reads params[:resource] and allows the usage of _id' do
    get :new, params: { resource: { user_id: 1 } }
    assert_response :success
    assert_template 'new'
  ...
  test 'get new reads params[:resource]' do
    get :new, params: { resource: { user_id: 1, name: 'Chunky Bacon'} }
    assert_response :success
    assert_template 'new'
  ...
  test 'should create project' do
    ...
    assert_difference('Project.count') do
      post :create, params: { project: { user_id: user.id, name: 'Chunky Bacon' } }
    end
  ...
  test 'should update project' do
    ...
    patch :update, params: { id: project, project: { user_id: user.id } }
